/** The list of possible words - simplified for Edge Runtime compatibility */
export const words = [
	'about', 'above', 'abuse', 'actor', 'acute', 'admit', 'adopt', 'adult', 'after', 'again',
	'agent', 'agree', 'ahead', 'alarm', 'album', 'alert', 'alien', 'align', 'alike', 'alive',
	'allow', 'alone', 'along', 'alter', 'amaze', 'amber', 'amend', 'among', 'anger', 'angle',
	'angry', 'apart', 'apple', 'apply', 'arena', 'argue', 'arise', 'armor', 'array', 'arrow',
	...
	'brown', 'build', 'built', 'buyer', 'cable', 'calm', 'came', 'canal', 'candy', 'carry',
